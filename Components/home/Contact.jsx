...
const Contact = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://toggletechlab.s3.us-east-2.amazonaws.com/AboutPage/About+BG-min.png')",
      }}
    >
      <div className="md:flex justify-between items-center w-3/4 mx-auto">
        <div className="md:w-3/5">
          ...
          <h1 className="ml-2 text-white text-xl md:text-2xl mt-4 mb-8">
            Immerse yourself in the future of your startup with prototypes that
            showcase your vision and attract investors.
          </h1>
        </div>
