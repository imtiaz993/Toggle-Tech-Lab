  ...
  return (
    <div className="lg:w-4/6">
      ...
      <div className="md:flex justify-between md:mb-5">
        <input
          className="text-lg w-full mb-5 md:mb-0 md:w-1/2 md:mr-8 text-white bg-transparent border border-dark-grey rounded-lg p-3"
          type="text"
          placeholder="Name *"
          required
        />
        <input
          className="text-lg w-full mb-5 md:mb-0 md:w-1/2 text-white bg-transparent border border-dark-grey rounded-lg p-3"
          type="tel"
          placeholder="Phone"
        />
      </div>
