    ...
    <div className="w-11/12  md:w-3/4 mx-auto mt-20">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col items-center md:justify-center mb-12">
          ...
          <p className="text-gold text-lg text-center">Founder / CEO</p>
        </div>
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
          ...
          <p className="text-gold text-lg text-center">Co-Founder</p>
        </div>
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
          ...
          <p className="text-gold text-lg text-center">VR & AR Developer</p>
        </div>
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
        ...
        <div className="flex flex-col items-center md:justify-center mb-12">
          ...
          <p className="text-gold text-lg text-center">Game developer</p>
        </div>
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
          ...
          <p className="text-gold text-lg text-center">XR User Experience Designer</p>
        </div>
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
          ...
          <p className="text-gold text-lg text-center">3D Designer</p>
        </div>
        <div className="flex flex-col items-center md:justify-center mb-12">
          ...
          <p className="text-gold text-lg text-center">Contact Us</p>
        </div>
      </div>
    </div>
  );
