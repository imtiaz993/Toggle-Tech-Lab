      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <div className="rounded-2xl pt-14 px-16">
            ...
            <p className="text-grey text-base md:text-lg">Facebook, Snapchat, Instagram</p>
        ...
        >
          <div className="rounded-2xl pt-14 px-16">
            ...
            <p className="text-grey text-base md:text-lg">360º video and picture creation suitable for VR and 3D web experiences.</p>
        ...
        >
          <div className="rounded-2xl pt-14 px-16">
            ...
            <p className="text-grey text-base md:text-lg">Company engagement and Brand recognition games</p>
            <ul className="list-disc ml-6 text-base md:text-lg">
              <li className="mt-2 text-gold">
                <div className="text-grey">
